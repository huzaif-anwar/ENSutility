...
def send_email(html_content):
    ...
    server = smtplib.SMTP('mailrelay.corp.intranet', 25)  # Gmail's SMTP server
    ...
    msg['Subject'] = f"EPWF Fallout Analysis Report - Autogenerated Email - {formatted_date}"
...
def send_email_for_update_queries():
    ...
    # msg['To'] = test_recipients
    msg['Subject'] = f"Update Queries for Production - Autogenerated Email - {formatted_date}"
...
def send_cpe_email(file_path):
    ...
    # msg['To'] = test_recipients
    msg['Subject'] = f"CPE data for Production - Autogenerated Email - {formatted_date}"
...
def send_mdw_report_email():
    ...
    if os.path.exists(file_path) and os.path.getsize(file_path) > 0:
        ...
        # msg['To'] = test_recipients
        msg['Subject'] = f"MDW Fallout Report - Autogenerated Email - {formatted_date}"
...
def send_payment_ids_email():
    # Set up the SMTP server
    server = smtplib.SMTP('mailrelay.corp.intranet', 25)
    ...
    # msg['To'] = test_recipients
    msg['Subject'] = f"Approved Payment IDs - Autogenerated Email - {formatted_date}"
