...
def send_email(html_content):
    ...
    msg[
        'To'] = "TeamPayOneA2@lumen.com, TeamPayTwo@lumen.com, pmt_system_fallout@lumen.com, " \
...
def send_mdw_report_email():
    ...
    if os.path.exists(file_path) and os.path.getsize(file_path) > 0:
        ...
        msg = MIMEMultipart()
        msg['From'] = "epwfbatch@centurylink.com"  # replace with your Gmail address
        msg['To'] = "kanishk.seth1@lumen.com, priyanka.sharma1@lumen.com, TeamPayOneA2@lumen.com"
        # msg['To'] = "anvesh.kashyap@lumen.com"
...
def send_payment_ids_email():
    ...
    # Create the email message
    msg = MIMEMultipart()
    msg['From'] = "epwfbatch@centurylink.com"
    msg['To'] = "TeamPayOneA2@lumen.com"
    # msg['To'] = "anvesh.kashyap@lumen.com"
